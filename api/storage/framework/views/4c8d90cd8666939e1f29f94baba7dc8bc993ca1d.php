<?php $__env->startSection('title', 'Passageiros '); ?>
        ...
        <div class="box box-block bg-white">
            ...
            <form action="<?php echo e(route('admin.user.index')); ?>" method="get">
                <div class="form-group row col-md-12" style="padding-left:0 !important; padding-right:0 !important; margin-bottom: 20px;">
                    ...
                    <div class="col-xs-3">
                        <a href="<?php echo e(route('admin.user.create')); ?>" style="margin-left: 1em;" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Adicionar Novo</a>
