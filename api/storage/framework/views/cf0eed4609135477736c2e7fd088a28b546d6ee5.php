...
<?php $__env->startSection('title', 'Detalhes da Viagem '); ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <dl class="row">
                        ...
                        <dt class="col-sm-4"><?php echo app('translator')->getFromJson('admin.request.tipo_corrida'); ?></dt>
                        <dd class="col-sm-8"> <?php if($request->is_instant_ride !='1'): ?>
                         NORMAL
                        <?php else: ?>
                         AVULSA
                        <?php endif; ?>
                       ...
                       <!--  <dt class="col-sm-4"><?php echo app('translator')->getFromJson('admin.request.surge_price'); ?> :</dt>
                        ...
                        <dd class="col-sm-8">
                            ...
                            <?php elseif($request->payment_mode == "DEBIT_MACHINE"): ?>
                                DÉBITO MÁQUINA
                            <?php elseif($request->payment_mode == "PIC_PAY"): ?>
                                PIC PAY
                                <?php elseif($request->payment_mode == "M_P"): ?>
                                MERCADO PAGO
