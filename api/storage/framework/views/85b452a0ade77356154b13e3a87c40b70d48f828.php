    ...
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <div class="clearfix" style="margin-top: 15px;">
                ...
                <form class="form-horizontal" action="<?php echo e(route('admin.ride.statement.range')); ?>" method="GET" enctype="multipart/form-data" role="form">
                    ...
                    <div class="box box-block bg-white tile tile-1 mb-2" style="border-top-color: #f44236 !important;">
                        ...
                        <div class="t-content">
                          <h6 class="text-uppercase mb-1"></h6>
                            ...
                            <h1 class="mb-1"><?php echo e($total); ?></h1>
                           
                            <i class="fa fa-caret-down text-danger mr-0-5"></i><span><h6 class="text-uppercase mb-1"><?php echo app('translator')->getFromJson('admin.dashboard.Revenue'); ?></h6>
                            Total de KM até o momento<h3 class="mb-1"><?php echo e(($cancel_rides)); ?></h3></span>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table table-striped table-bordered dataTable" id="table-4">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo app('translator')->getFromJson('admin.request.tipo_corrida'); ?></th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php elseif($ride->payment_mode == "DEBIT_MACHINE"): ?>
                                                DÉBITO MÁQUINA
                                            <?php elseif($ride->payment_mode == "PIC_PAY"): ?>
                                                PIC PAY
                                            <?php elseif($ride->payment_mode == "M_P"): ?>
                                                MERCADO PAGO
