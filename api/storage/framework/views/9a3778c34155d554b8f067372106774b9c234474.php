            ...
            <form class="form-horizontal" action="<?php echo e(route('admin.service.store')); ?>" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control numbers" type="number" value="<?php echo e(old('waiting_free_mins')); ?>" name="waiting_free_mins" id="waiting_free_mins" placeholder="<?php echo app('translator')->getFromJson('admin.service.waiting_wave'); ?>" min="0">
                    </div>
                    <div class="col-xs-5">
                        <input class="form-control price" type="number" value="<?php echo e(old('waiting_min_charge')); ?>" name="waiting_min_charge" id="waiting_min_charge" placeholder="<?php echo app('translator')->getFromJson('admin.service.waiting_charge'); ?>" min="0">
                    </div>
                </div>
