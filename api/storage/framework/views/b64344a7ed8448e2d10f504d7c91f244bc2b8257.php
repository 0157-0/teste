<?php $__env->startSection('title', 'Adicionar Documento '); ?>
...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <h5 style="margin-bottom: 2em;"><?php echo app('translator')->getFromJson('admin.document.add_Document'); ?></h5>
            ...
            <form class="form-horizontal" action="<?php echo e(route('admin.document.store')); ?>" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row">
                    <label for="name" class="col-xs-12 col-form-label"><?php echo app('translator')->getFromJson('admin.document.document_name'); ?></label>
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="<?php echo e(old('name')); ?>" name="name" required id="name" placeholder="Nome do <?php echo app('translator')->getFromJson('admin.document.document_name'); ?>">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="name" class="col-xs-12 col-form-label"><?php echo app('translator')->getFromJson('admin.document.document_type'); ?></label>
                    <div class="col-xs-10">
                        <select name="type">
