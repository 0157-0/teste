    ...
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <div style="text-align: center;padding: 20px;color: blue;font-size: 24px;">
                ...
                <?php elseif(isset($statement_for) && $statement_for !="provider"): ?>
                <span><?php echo app('translator')->getFromJson('admin.dashboard.over_commission'); ?> : <?php echo e(currency($revenue[0]->commission)); ?></span>
                <?php endif; ?>
            </div>
                            ...
                            <table class="table table-striped table-bordered dataTable" id="table-4">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php endif; ?>
                                        <?php if(isset($statement_for) && $statement_for !="user"): ?>
                                        <td><?php echo e(currency($ride->payment['provider_pay'])); ?></td>
                                        <?php else: ?>
                                        ...
                                        <td>
                                            <a class="text-primary" href="<?php echo e(route('fleet.requests.show',$ride->id)); ?>"><span class="underline">Ver detalhes</span></a>									
                                        </td>
                                    </tr>
