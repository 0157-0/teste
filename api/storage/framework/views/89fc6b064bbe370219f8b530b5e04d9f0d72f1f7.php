...
<body class="fixed-sidebar fixed-header content-appear skin-2">
    ...
    <div class="wrapper">
        ...
        <?php echo $__env->make('fleet.include.nav', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>

        <?php echo $__env->make('fleet.include.header', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <div class="site-content">
            ...
            <?php echo $__env->make('fleet.include.footer', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
