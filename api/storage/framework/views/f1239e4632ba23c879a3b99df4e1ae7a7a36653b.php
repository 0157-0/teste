<?php $__env->startSection('title', 'Add User Dispute'); ?>
            ...
            <form class="form-horizontal" action="<?php echo e(route('admin.userdisputestore')); ?>" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					...
					<div class="col-xs-5">
						<div class="input-group">
							<input class="form-control" type="text" value="<?php echo e(old('name')); ?>" name="name" id="namesearch" placeholder="Nome do Usuário" required="" aria-describedby="basic-addon2" autocomplete="off">
				...
				<div class="form-group row">
					...
					<div class="col-xs-5">
						...
						<textarea style="display: none;margin-top:5px;" class="form-control" name="dispute_other" required id="dispute_other" placeholder="<?php echo app('translator')->getFromJson('admin.dispute.dispute_name'); ?>"><?php echo e(old('dispute_other')); ?></textarea>
					</div>
				</div>
