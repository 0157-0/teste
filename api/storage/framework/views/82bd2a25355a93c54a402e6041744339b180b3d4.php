                ...
                <div class="card card-block card-inverse card-primary">
                    <blockquote class="card-blockquote">
                        ...
                        <div class="payment_settings" <?php if(config('constants.card') == 0): ?> style="display: none;" <?php endif; ?>>
                            <div class="form-group row">
                                <label for="stripe_secret_key" class="col-xs-4 col-form-label"><?php echo app('translator')->getFromJson('admin.payment.stripe_secret_key'); ?></label>
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" value="<?php echo e(config('constants.stripe_secret_key')); ?>" name="stripe_secret_key" id="stripe_secret_key"  placeholder="<?php echo app('translator')->getFromJson('admin.payment.stripe_secret_key'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="stripe_publishable_key" class="col-xs-4 col-form-label"><?php echo app('translator')->getFromJson('admin.payment.stripe_publishable_key'); ?></label>
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" value="<?php echo e(config('constants.stripe_publishable_key')); ?>" name="stripe_publishable_key" id="stripe_publishable_key"  placeholder="<?php echo app('translator')->getFromJson('admin.payment.stripe_publishable_key'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="stripe_currency" class="col-xs-4 col-form-label"><?php echo app('translator')->getFromJson('admin.payment.currency'); ?></label>
                                <div class="col-xs-8">
                ...
                <div class="card card-block card-inverse card-primary">
                    ...
                    <i class="fa fa-3x fa-credit-card pull-right"></i>
                       <div class="form-group row">
                            ...
                            <div class="col-xs-6">
                                <input <?php if(config('constants.pic_pay') == 1): ?> checked  <?php endif; ?> autocomplete="off" name="pic_pay" id="pic_pay" type="checkbox" class="js-switch" data-color="#43b968">
                            </div>
                        </div>
                    </blockquote>
                </div><!-- PICPAY-->
                ...
                <div class="card card-block card-inverse card-primary">
                    ...
                    <i class="fa fa-3x fa-credit-card pull-right"></i>
                       <div class="form-group row">
                            ...
                            <div class="col-xs-6">
                                <input <?php if(config('constants.mercado_pago') == 1): ?> checked  <?php endif; ?> autocomplete="off" name="mercado_pago" id="mercado_pago" type="checkbox" class="js-switch" data-color="#43b968">
                            </div>
                        </div>
                    </blockquote>
                </div><!-- PICPAY-->
...
<!--                <div class="card card-block card-inverse card-primary">
                    <blockquote class="card-blockquote">
                        ...
                        <div class="payment_settings" <?php if(config('constants.payumoney') == 0): ?> style="display: none;" <?php endif; ?>>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" value="<?php echo e(config('constants.payumoney_merchant_id')); ?>" name="payumoney_merchant_id" id="payumoney_merchant_id"  placeholder="<?php echo app('translator')->getFromJson('admin.payment.payumoney_merchant_id'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" value="<?php echo e(config('constants.payumoney_key')); ?>" name="payumoney_key" id="payumoney_key"  placeholder="<?php echo app('translator')->getFromJson('admin.payment.payumoney_key'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" value="<?php echo e(config('constants.payumoney_salt')); ?>" name="payumoney_salt" id="payumoney_salt"  placeholder="<?php echo app('translator')->getFromJson('admin.payment.payumoney_salt'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" value="<?php echo e(config('constants.payumoney_auth')); ?>" name="payumoney_auth" id="payumoney_auth"  placeholder="<?php echo app('translator')->getFromJson('admin.payment.payumoney_auth'); ?>">
                                </div>
                            </div>
                        </div>
                    </blockquote>
                    ...
                    <blockquote class="card-blockquote">
                        ...
                        <div class="payment_settings" <?php if(config('constants.paypal') == 0): ?> style="display: none;" <?php endif; ?>>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" value="<?php echo e(config('constants.paypal_client_id')); ?>" name="paypal_client_id" id="paypal_client_id"  placeholder="<?php echo app('translator')->getFromJson('admin.payment.paypal_client_id'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" value="<?php echo e(config('constants.paypal_client_secret')); ?>" name="paypal_client_secret" id="paypal_client_secret"  placeholder="<?php echo app('translator')->getFromJson('admin.payment.paypal_client_secret'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                    ...
                    <blockquote class="card-blockquote">
                        ...
                        <div class="payment_settings" <?php if(config('constants.paypal_adaptive') == 0): ?> style="display: none;" <?php endif; ?>>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" value="<?php echo e(config('constants.paypal_username')); ?>" name="paypal_username" id="paypal_username"  placeholder="<?php echo app('translator')->getFromJson('admin.payment.paypal_username'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" value="<?php echo e(config('constants.paypal_password')); ?>" name="paypal_password" id="paypal_password"  placeholder="<?php echo app('translator')->getFromJson('admin.payment.paypal_password'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" value="<?php echo e(config('constants.paypal_secret')); ?>" name="paypal_secret" id="paypal_secret"  placeholder="<?php echo app('translator')->getFromJson('admin.payment.paypal_secret'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-xs-8">
                                    <input class="form-control" type="file" name="paypal_certificate" id="paypal_certificate" placeholder="<?php echo app('translator')->getFromJson('admin.payment.paypal_certificate'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" value="<?php echo e(config('constants.paypal_app_id')); ?>" name="paypal_app_id" id="paypal_app_id"  placeholder="<?php echo app('translator')->getFromJson('admin.payment.paypal_app_id'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                    ...
                    <blockquote class="card-blockquote">
                        ...
                        <div class="payment_settings" <?php if(config('constants.braintree') == 0): ?> style="display: none;" <?php endif; ?>>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" value="<?php echo e(config('constants.braintree_merchant_id')); ?>" name="braintree_merchant_id" id="braintree_merchant_id"  placeholder="<?php echo app('translator')->getFromJson('admin.payment.braintree_merchant_id'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" value="<?php echo e(config('constants.braintree_public_key')); ?>" name="braintree_public_key" id="braintree_public_key"  placeholder="<?php echo app('translator')->getFromJson('admin.payment.braintree_public_key'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" value="<?php echo e(config('constants.braintree_private_key')); ?>" name="braintree_private_key" id="braintree_private_key"  placeholder="<?php echo app('translator')->getFromJson('admin.payment.braintree_private_key'); ?>">
                                </div>
                            </div>
                        </div>
                    </blockquote>
                    ...
                    <blockquote class="card-blockquote">
                        ...
                        <div class="payment_settings" <?php if(config('constants.paytm') == 0): ?> style="display: none;" <?php endif; ?>>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" value="<?php echo e(config('constants.paytm_merchant_id')); ?>" name="paytm_merchant_id" id="paytm_merchant_id"  placeholder="<?php echo app('translator')->getFromJson('admin.payment.paytm_merchant_id'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" value="<?php echo e(config('constants.paytm_merchant_key')); ?>" name="paytm_merchant_key" id="paytm_merchant_key"  placeholder="<?php echo app('translator')->getFromJson('admin.payment.paytm_merchant_key'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="offset-xs-4 col-xs-4">
                        <button type="submit" class="btn btn-primary btn-block"><?php echo app('translator')->getFromJson('admin.payment.update_site_settings'); ?></button>
                    </div>
                </div>
            </form>
            </div>
     ...
     <div class="form-box row">
            ...
            <form action="<?php echo e(route('admin.settings.payment.store')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="card card-block card-inverse card-info">
                    <blockquote class="card-blockquote">
                        <div class="form-group row">
                            <label for="daily_target" class="col-xs-4 col-form-label"><?php echo app('translator')->getFromJson('admin.payment.daily_target'); ?></label>
                            <div class="col-xs-8">
                        ...
                        <div class="form-group row">
                            <label for="tax_percentage" class="col-xs-4 col-form-label"><?php echo app('translator')->getFromJson('admin.payment.tax_percentage'); ?></label>
                            <div class="col-xs-8">
                                <input class="form-control"
                                    type="number"
...
<!--                         <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="commission_percentage" class="col-xs-4 col-form-label"><?php echo app('translator')->getFromJson('admin.payment.commission_percentage'); ?></label>
                            <div class="col-xs-8">
                                <input class="form-control"
                                    type="number"
...
<!--                        <div class="form-group row">
                            <label for="fleet_commission_percentage" class="col-xs-4 col-form-label"><?php echo app('translator')->getFromJson('admin.payment.fleet_commission_percentage'); ?> <span style="color:red">(It will work if admin commission 0%) </span> </label>
                            <div class="col-xs-8">
                                <input class="form-control"
                                    type="number"
                        ...
                        <div class="form-group row">
                            <label for="peak_percentage" class="col-xs-4 col-form-label"><?php echo app('translator')->getFromJson('admin.payment.peak_percentage'); ?></label>
                            <div class="col-xs-8">
                                <input class="form-control"
                                    type="number"
                        ...
                        <div class="form-group row">
                            <label for="waiting_percentage" class="col-xs-4 col-form-label"><?php echo app('translator')->getFromJson('admin.payment.waiting_percentage'); ?></label>
                            <div class="col-xs-8">
                                <input class="form-control"
                                    type="number"
                        ...
                        <div class="form-group row">
                            <label for="minimum_negative_balance" class="col-xs-4 col-form-label"><?php echo app('translator')->getFromJson('admin.payment.minimum_negative_balance'); ?></label>
                            <div class="col-xs-8">
                                <input class="form-control"
                                    type="number"
