<?php $__env->startSection('title', 'Cupons Promocionais '); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="<?php echo e(route('admin.promocode.destroy', $promo->id)); ?>" method="POST">
                                    ...
                                    <a href="<?php echo e(route('admin.promocode.edit', $promo->id)); ?>" class="btn btn-info"><i class="fa fa-pencil"></i> Editar</a>
                                    <?php endif; ?>
