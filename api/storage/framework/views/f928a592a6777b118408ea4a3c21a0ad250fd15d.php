...
<!--        <div id="first_step">
            ...
            <div class="col-md-8">
                <input type="phone" autofocus id="phone_number" class="form-control" placeholder="<?php echo app('translator')->getFromJson('provider.signup.enter_phone'); ?>" name="phone_number" value="<?php echo e(old('phone_number')); ?>" data-stripe="number" maxlength="11" onkeypress="return isNumberKey(event);"/>
            </div>
        ...
        <div id="second_step">
            ...
            <div>
                <input id="lname" type="text" class="form-control" name="last_name" value="<?php echo e(old('last_name')); ?>" placeholder="<?php echo app('translator')->getFromJson('provider.profile.last_name'); ?>"data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="<?php echo app('translator')->getFromJson('provider.profile.last_name'); ?> can only contain alphanumeric characters and . - spaces">            
            ...
            <div>
                <input id="email" type="email" class="form-control" name="email" value="<?php echo e(old('email')); ?>" placeholder="<?php echo app('translator')->getFromJson('provider.signup.email_address'); ?>" data-validation="email">            
            ...
            <div>
                <input id="cpf" type="cpf" class="form-control" name="cpf" value="<?php echo e(old('email')); ?>" placeholder="CPF" data-validation="cpf">            
                <?php if($errors->has('email')): ?>
                    <span class="help-block">
                        <strong><?php echo e($errors->first('email')); ?></strong>
                    </span>
...
<!--            <div class="col-md-4">
            ...
            <div>
                <input id="password" type="password" class="form-control" name="password" placeholder="<?php echo app('translator')->getFromJson('provider.signup.password'); ?>" data-validation="length" data-validation-length="min6" data-validation-error-msg="Password should not be less than 6 characters">
            ...
            <div>
                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" placeholder="<?php echo app('translator')->getFromJson('provider.signup.confirm_password'); ?>" data-validation="confirmation" data-validation-confirm="password" data-validation-error-msg="Confirm Passsword is not matched">
            ...
            <div>
                <input id="service-model" type="text" class="form-control" name="paypal_email" value="<?php echo e(old('paypal_email')); ?>" placeholder="<?php echo app('translator')->getFromJson('provider.profile.paypal_email'); ?>" data-validation="email">
            ...
            <div>
                <input id="service-model" type="text" class="form-control" name="service_model" value="<?php echo e(old('service_model')); ?>" placeholder="<?php echo app('translator')->getFromJson('provider.profile.car_model'); ?>" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="<?php echo app('translator')->getFromJson('provider.profile.car_model'); ?> can only contain alphanumeric characters and - spaces">
