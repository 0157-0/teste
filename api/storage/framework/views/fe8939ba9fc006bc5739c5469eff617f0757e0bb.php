        ...
        <div class="container-fluid">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('provider-services')): ?>
                <div class="box box-block bg-white">
                    ...
                    <p>Franquia: <b><?php echo e($ProviderFleet ? $ProviderFleet->name : 'N/A'); ?></b> </p>
                    ...
                    <div class="row">
                            ...
                            <?php if($ProviderService->count() > 0): ?>
                                ...
                                <table class="table table-striped table-bordered dataTable">
                                    ...
                                    <?php $__currentLoopData = $ProviderService; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($service->service_type->name); ?> - <?php echo e($service->service_type->fleet->name); ?></td>
                                                ...
                                                <?php if( Setting::get('demo_mode', 0) == 0): ?>
                                                    <form action="<?php echo e(route('admin.provider.document.service', [$Provider->id, $service->id])); ?>"
                                                        ...
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('provider-service-delete')): ?>
                                                            <button class="btn btn-danger btn-large btn-block"><?php echo app('translator')->getFromJson('admin.delete'); ?></a><?php endif; ?>
                                                    </form>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                        ...
                        <form action="<?php echo e(route('admin.provider.document.store', $Provider->id)); ?>" method="POST">
                            ...
                            <?php if( Setting::get('demo_mode', 0) == 0): ?>
                            <div class="col-xs-3">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('provider-service-update')): ?><button class="btn btn-primary btn-block" type="submit">Atualizar</button><?php endif; ?>
                            </div>
                            <?php endif; ?>
                        </form>
                        <br>
                        ...
                        <form action="<?php echo e(route('admin.provider.document.store', $Provider->id)); ?>" method="POST">
                            ...
                            <?php if( Setting::get('demo_mode', 0) == 0): ?>
                            <div class="col-xs-3">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('provider-service-update')): ?><button class="btn btn-success btn-block" type="submit">Adicionar</button><?php endif; ?>
                            </div>
                            <?php endif; ?>
                        </form>
                                ...
                                <?php if($Provider->documents()->count()): ?>
                                    <?php if($Provider->documents->last()->status == "ACTIVE"): ?>
                                        <a class="btn btn-success btn-block"
                                           href="<?php echo e(route('admin.provider.approve', $Provider->id )); ?>">Aprovar</a>
                                    <?php endif; ?>
                                <?php endif; ?>
                            <?php endif; ?>
                        <?php endif; ?>
