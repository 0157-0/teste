        ...
        <div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="<?php echo e(route('admin.service.update', $service->id )); ?>" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control" type="text" id="currency_minute" data-thousands="." data-decimal="," value="<?php echo e($service->minute); ?>" name="minute" id="minute" placeholder="<?php echo app('translator')->getFromJson('admin.service.unit_time'); ?>" min="0.00">
                    </div>
                    <div class="col-xs-5">
                ...
                <div class="form-group row">
                     <label for="description" class="col-xs-12 col-form-label" style="color: black;font-size: 25px;">Horário de pico</label>
                 ...
                 <div class="form-group row">
                    <label for="" class="col-xs-12 col-form-label" style="color: black;font-size: 25px;">Taxa de espera</label>
                    ...
                    <div class="col-xs-5">
                        <input class="form-control" type="number" value="<?php echo e($service->waiting_free_mins); ?>" name="waiting_free_mins" id="waiting_free_mins"  min="0.00">
                    </div>
                    <div class="col-xs-5">
                        <input class="form-control" type="" value="<?php echo e($service->waiting_min_charge); ?>" name="waiting_min_charge" id="waiting_min_charge" placeholder="<?php echo app('translator')->getFromJson('admin.service.waiting_charge'); ?>" min="0.00">
                    </div>
