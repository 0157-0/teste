            ...
            <table class="table table-striped table-bordered dataTable" id="table-5">
                <thead>
                    <tr>
                        ...
                        <th><?php echo app('translator')->getFromJson('admin.request.link_picpay'); ?></th>
                        <th><?php echo app('translator')->getFromJson('admin.request.link_mp'); ?></th>
                ...
                <?php ($page++); ?>
                    <tr>
                        ...
                        <td><?php echo e($provider->link_picpay); ?></td>
                        <td><?php echo e($provider->link_mp); ?></td>
                        ...
                        <td>
                            <div class="input-group-btn">
                                ...
                                <a class="btn btn-danger btn-block" href="<?php echo e(route('admin.provider.disapprove', $provider->id )); ?>">Desativar</a>
                                <?php else: ?>
                                <a class="btn btn-success btn-block" href="<?php echo e(route('admin.provider.approve', $provider->id )); ?>">Aprovar</a>
                                <?php endif; ?>
                                <?php endif; ?>
