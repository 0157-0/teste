...
<!--                            <div id="first_step">
                                ...
                                <div class="col-md-8">
                                    <input type="text" autofocus id="phone_number" class="form-control" placeholder="Número celular com DDD" name="phone_number" value="<?php echo e(old('phone_number')); ?>" data-stripe="number" maxlength="11" onkeypress="return isNumberKey(event);" required/>
                                </div>
                            ...
                            <div id="second_step">
                                ...
                                <div class="col-md-6">
                                    <input type="text" autofocus class="form-control" placeholder="Nome" name="first_name" value="<?php echo e(old('first_name')); ?>" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="First Name can only contain alphanumeric characters and . - spaces">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" placeholder="Sobrenome" name="last_name" value="<?php echo e(old('last_name')); ?>" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="Last Name can only contain alphanumeric characters and . - spaces">
                                ...
                                <div class="col-md-12">
                                    <input type="email" class="form-control" name="email" placeholder="E-mail" value="<?php echo e(old('email')); ?>" data-validation="email">
                                ...
                                <div class="col-md-12">
                                    <input type="text" id="phone_number" class="form_tel" class="form-control" placeholder="Número celular com DDD" name="phone_number" value="<?php echo e(old('phone_number')); ?>" data-stripe="number" maxlength="11" onkeypress="return isNumberKey(event);" required/>
                                </div>
