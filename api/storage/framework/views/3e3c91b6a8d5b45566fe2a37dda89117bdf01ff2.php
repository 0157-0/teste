<?php $__env->startSection('title', 'Adicionar Passageiro '); ?>
    ...
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="<?php echo e(route('admin.user.store')); ?>" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row">
                    <label for="country_code" class="col-xs-12 col-form-label"><?php echo app('translator')->getFromJson('admin.users.country_code'); ?></label>
                    <div class="col-xs-10">
