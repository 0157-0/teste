                ...
                <form class="form-horizontal" action="<?php echo e(route('admin.user.update', $user->id )); ?>" method="POST"
                    ...
                    <div class="form-group row">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-xs-10">
                          <input class="form-control" type="text"    value= "<?php echo e($user->wallet_balance); ?>" data-decimal="," name="wallet_balance" required id="wallet_balance" placeholder="CARTEIRA">
                        </div>
                    </div>
