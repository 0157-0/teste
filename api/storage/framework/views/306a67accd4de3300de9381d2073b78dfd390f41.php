...
<?php $__env->startSection('content'); ?>
    ...
    <form role="form" method="POST" action="<?php echo e(url('/provider/password/email')); ?>">
        ...
        <div class="col-md-12">
            <input type="email" class="form-control" name="email" placeholder="<?php echo app('translator')->getFromJson('provider.signup.email_address'); ?>" value="<?php echo e(old('email')); ?>">
