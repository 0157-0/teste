<?php $__env->startSection('title', 'Novo Gerente de Disputa '); ?>
...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <h5 style="margin-bottom: 2em;"><?php echo app('translator')->getFromJson('admin.dispute-manager.add_dispute_manager'); ?></h5>

            <form class="form-horizontal" action="<?php echo e(route('admin.dispute-manager.store')); ?>" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="password" name="password_confirmation" id="password_confirmation" placeholder="<?php echo app('translator')->getFromJson('admin.dispute-manager.password_confirmation'); ?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <button type="submit" class="btn btn-primary"><?php echo app('translator')->getFromJson('admin.dispute-manager.add_dispute_manager'); ?></button>
                        <a href="<?php echo e(route('admin.dispute-manager.index')); ?>" class="btn btn-default"><?php echo app('translator')->getFromJson('admin.cancel'); ?></a>
                    </div>
                </div>
            </form>
        </div>
