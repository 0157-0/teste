...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            <a href="<?php echo e(route($back_route)); ?>" class="btn btn-default pull-right"><i class="fa fa-angle-left"></i> <?php echo app('translator')->getFromJson('admin.back'); ?></a>
            ...
            <form class="form-horizontal" action="<?php echo e(route('admin.transferstore')); ?>" method="POST" enctype="multipart/form-data" role="form" autocomplete="off">
                ...
                <div class="form-group row">
                    <?php if($type==1): ?>
                    <label for="namesearch" class="col-xs-2 col-form-label"><?php echo app('translator')->getFromJson('admin.service.Provider_Name'); ?></label>
                    <?php else: ?>
                    <label for="namesearch" class="col-xs-2 col-form-label"><?php echo app('translator')->getFromJson('admin.fleet.fleet_name'); ?></label>
                    <?php endif; ?>
                    <div class="col-xs-5">
                        <div class="input-group">
                            <input class="form-control" type="text" value="<?php echo e(old('name')); ?>" name="name" required id="namesearch" placeholder="Procurar por Nome" required="" aria-describedby="basic-addon2">
                ...
                <div class="form-group row">
                    <label for="amount" class="col-xs-2 col-form-label"><?php echo app('translator')->getFromJson('admin.amount'); ?></label>
                    <div class="col-xs-5">
                        <input class="form-control" type="text" value="<?php echo e(old('amount')); ?>" name="amount" id="amount" placeholder="Informe o valor" required="" min="1">
                    </div>
                    <div class="col-xs-5">
                ...
                <div class="form-group row">
                    <label for="type" class="col-xs-2 col-form-label"><?php echo app('translator')->getFromJson('admin.type'); ?></label>
                    <div class="col-xs-5">
                ...
                <div class="form-group row">
                    <label for="send_by" class="col-xs-2 col-form-label"><?php echo app('translator')->getFromJson('admin.by'); ?></label>
                    <div class="col-xs-5">
