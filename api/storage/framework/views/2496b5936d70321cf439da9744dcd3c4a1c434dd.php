...
<div class="content-area py-1">
    <div class="container-fluid">
        ...
        <div class="box box-block bg-white">
            ...
            <embed src="<?php echo e(asset('storage/'.$Document->url)); ?>" width="100%" height="100%" />

            <div class="row">
                <div class="col-xs-6">
                    <form action="<?php echo e(route('fleet.provider.document.update', [$Document->provider->id, $Document->id])); ?>" method="POST">
                ...
                <div class="col-xs-6">
                    <form action="<?php echo e(route('fleet.provider.document.destroy', [$Document->provider->id, $Document->id])); ?>" method="POST">
                        <?php echo e(csrf_field()); ?>
