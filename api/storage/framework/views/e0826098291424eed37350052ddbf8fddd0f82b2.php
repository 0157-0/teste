...
<div class="content-area py-1">
    <div class="container-fluid">
        ...
        <div class="col-md-12" style="height:50px;color:red;">
            ...
            <a href="<?php echo e(route('admin.role.create')); ?>" style="margin-left: 1em;" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> <?php echo app('translator')->getFromJson('admin.roles.add_role'); ?></a>
            <?php endif; ?>
