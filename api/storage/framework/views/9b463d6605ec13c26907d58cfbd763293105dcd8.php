<?php $__env->startSection('title', 'Atualizar Função '); ?>
...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <h5 style="margin-bottom: 2em;"><?php echo app('translator')->getFromJson('admin.roles.update_role'); ?></h5>
            ...
            <form class="form-horizontal" action="<?php echo e(route('admin.role.update', $role->id )); ?>" method="POST" role="form">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="<?php echo e($role->name); ?>" name="name" required id="name" placeholder="<?php echo app('translator')->getFromJson('admin.name'); ?>">
                    </div>
                </div>
