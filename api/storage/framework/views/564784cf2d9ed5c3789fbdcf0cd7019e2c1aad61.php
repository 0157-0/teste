                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('dashboard-menus')): ?>
                    ...
                    <div class="col-lg-3 col-md-6 col-xs-12">
                        <div class="box box-block bg-success tile tile-1 mb-2">
                            ...
                            <div class="t-content">
                                <h6 class="text-uppercase mb-1"><?php echo app('translator')->getFromJson('admin.dashboard.scheduled'); ?></h6>
            ...
            <div class="row row-md mb-2">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('wallet-summary')): ?>
                    <div class="col-md-4">
                        <div class="box bg-white">
                            <div class="box-block clearfix">
                                <h5 class="float-xs-left"><?php echo app('translator')->getFromJson('admin.dashboard.wallet_summary'); ?></h5>
                                <div class="float-xs-right">
                                </div>
                            </div>
