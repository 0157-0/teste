<?php $__env->startSection('title', 'Itens Perdidos '); ?>
...
<div class="content-area py-1">
    <div class="container-fluid">
        ...
        <div class="box box-block bg-white">
            ...
            <?php endif; ?>
            <h5 class="mb-1"><?php echo app('translator')->getFromJson('admin.lostitem.title'); ?></h5>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if($lost->status=='open'): ?>
                            <a href="<?php echo e(route('admin.lostitem.edit', $lost->id)); ?>" href="#" class="btn btn-info"><i class="fa fa-pencil"></i> Editar</a>
                            <?php endif; ?>   
                            <?php endif; ?> 
                            <?php endif; ?>                                
                        </td>
