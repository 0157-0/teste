    ...
    public function send_request(Request $request)
    {
        ...
        if ($request->ajax()) {
            $this->validate($request, [
                ...
                //TODO ALLAN - Alterações débito na máquina e voucher
                'payment_mode' => 'required|in:BRAINTREE,CASH,DEBIT_MACHINE,PIC_PAY,M_P,CARD,PAYPAL,PAYPAL-ADAPTIVE,PAYUMONEY,PAYTM',
            ...
            $this->validate($request, [
                ...
                //TODO ALLAN - Alterações débito na máquina e voucher
                'payment_mode' => 'required|in:CASH,CARD,DEBIT_MACHINE,PIC_PAY,M_P',
