...
<div class="row white-section pad-60">
    <div class="container">
        ...
        <div class="col-md-6">
            ...
            <p>{{ config('constants.site_title', 'Urbis')  }} é a maneira mais inteligente de se locomover. Um toque e um carro ou moto vai até você. Seu motorista sabe exatamente para onde ir. E você pode pagar com dinheiro ou cartão.</p>
